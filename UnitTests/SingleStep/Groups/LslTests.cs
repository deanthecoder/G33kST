...
public sealed class LslTests : CpuTestBase
{
    protected override string GroupName => "LSL";
    protected override IReadOnlyList<FileInfo> SourceFiles => GetFiles("LSL");

    public static IEnumerable<TestCaseData> TestFiles => CreateCases("LSL");
