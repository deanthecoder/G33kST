...
public sealed class ANDItoSRTests : CpuTestBase
{
    protected override string GroupName => "ANDItoSR";
    protected override IReadOnlyList<FileInfo> SourceFiles => GetFiles("ANDItoSR");
