...
public sealed class BclrTests : CpuTestBase
{
    protected override string GroupName => "BCLR";
    protected override IReadOnlyList<FileInfo> SourceFiles => GetFiles("BCLR");

    public static IEnumerable<TestCaseData> TestFiles => CreateCases("BCLR");
