...
public sealed class RolTests : CpuTestBase
{
    protected override string GroupName => "ROL";
    protected override IReadOnlyList<FileInfo> SourceFiles => GetFiles("ROL");

    public static IEnumerable<TestCaseData> TestFiles => CreateCases("ROL");
