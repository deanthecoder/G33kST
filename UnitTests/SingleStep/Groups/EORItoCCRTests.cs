...
public sealed class EORItoCCRTests : CpuTestBase
{
    protected override string GroupName => "EORItoCCR";
    protected override IReadOnlyList<FileInfo> SourceFiles => GetFiles("EORItoCCR");
