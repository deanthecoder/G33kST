...
public sealed class RteTests : CpuTestBase
{
    protected override string GroupName => "RTE";
    protected override IReadOnlyList<FileInfo> SourceFiles => GetFiles("RTE");

    public static IEnumerable<TestCaseData> TestFiles => CreateCases("RTE");
