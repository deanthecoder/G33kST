...
public sealed class BsrTests : CpuTestBase
{
    protected override string GroupName => "BSR";
    protected override IReadOnlyList<FileInfo> SourceFiles => GetFiles("BSR");

    public static IEnumerable<TestCaseData> TestFiles => CreateCases("BSR");
