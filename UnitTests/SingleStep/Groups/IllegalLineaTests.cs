...
public sealed class IllegalLineaTests : CpuTestBase
{
    protected override string GroupName => "ILLEGAL_LINEA";
    protected override IReadOnlyList<FileInfo> SourceFiles => GetFiles("ILLEGAL_LINEA");
