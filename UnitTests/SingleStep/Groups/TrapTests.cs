...
public sealed class TrapTests : CpuTestBase
{
    protected override string GroupName => "TRAP";
    protected override IReadOnlyList<FileInfo> SourceFiles => GetFiles("TRAP");

    public static IEnumerable<TestCaseData> TestFiles => CreateCases("TRAP");
