...
public sealed class MOVEtoCCRTests : CpuTestBase
{
    protected override string GroupName => "MOVEtoCCR";
    protected override IReadOnlyList<FileInfo> SourceFiles => GetFiles("MOVEtoCCR");
